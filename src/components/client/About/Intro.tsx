        ...
        <>
            ...
            <section className="bg-white py-8">
                <div className="container mx-auto flex flex-wrap pt-4">
                    ...
                    <div className="w-full mb-4">
                        <div className="h-1 mx-auto gradient bg-orange-500 w-64 opacity-25 my-0 py-0 rounded-t"></div>
                    </div>
                    <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                        <div className="flex-1 bg-white rounded-xl overflow-hidden border p-8 px-9">
                            <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                                <p className="w-full text-gray-600 text-xs md:text-sm">
                                    <i className="text-7xl bi bi-truck text-green-400"></i>
                                </p>
                                <div className="w-full font-semibold text-lg text-gray-800">
                                    Lorem ipsum dolor sit amet.
                                </div>
                    ...
                    <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                        <div className="flex-1 bg-white rounded-xl overflow-hidden border p-8 px-9">
                            <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                                <p className="w-full text-gray-600 text-xs md:text-sm">
                                    <i className="text-7xl bi bi-person-check-fill text-orange-400"></i>
                                </p>
                                <div className="w-full font-semibold text-lg text-gray-800">
                                    Lorem ipsum dolor sit amet.
                                </div>
                    ...
                    <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                        <div className="flex-1 bg-white rounded-xl overflow-hidden border p-8 px-9">
                            <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                                <p className="w-full text-gray-600 text-xs md:text-sm">
                                    <i className="text-7xl bi bi-trophy text-blue-400"></i>
                                </p>
                                <div className="w-full font-semibold text-lg text-gray-800">
                                    Lorem ipsum dolor sit amet.
                                </div>
