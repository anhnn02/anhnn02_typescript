...
const ProductDetailPage = () => {
    const [nameCate, setNameCate] = useState<CateProductType[]>([])
    const [relatedProduct, setRelatedProduct] = useState<CateProductType[]>([])
    const [product, setProduct] = useState<CateProductType[]>([])
    ...
    useEffect(() => {
        const getProduct = async () => {
            const { data: dataProduct } = await readProduct(productName);
