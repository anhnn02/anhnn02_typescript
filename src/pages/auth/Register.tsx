            ...
            <div className="auth-container m-auto">
                <div className="px-24 max-w-full flex">
                    <div className="relative w-[43%] mr-12">
                        <img src="https://cdn.dribbble.com/users/754899/screenshots/2985458/media/b8a16910e125ef377e7fb5941ef9082e.png?compress=1&resize=800x600&vertical=top" alt="" className="h-[550px] radius-secondary object-cover" />
